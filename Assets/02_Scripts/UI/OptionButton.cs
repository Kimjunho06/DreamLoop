...
public class OptionButton : MonoBehaviour
{
    ...
    private void OptionOpenBtnOffActive() => _optionOnBtn.gameObject.SetActive(false);
    private void OptionCloseBtnOnActive() => _optionOffBtn.gameObject.SetActive(true);
    private void OptionCloseBtnOffActive() => _optionOffBtn.gameObject.SetActive(false);
